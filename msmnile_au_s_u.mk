...
PRODUCT_NAME := msmnile_au_s_u
PRODUCT_DEVICE := msmnile_au_s_u
PRODUCT_BRAND := qti
PRODUCT_MODEL := msmnile_au_s_u for arm64
...
#Hibernation Script
PRODUCT_COPY_FILES += device/qcom/msmnile_au_s_u/hiber.sh:$(TARGET_COPY_OUT_VENDOR)/bin/hiber.sh
PRODUCT_COPY_FILES += device/qcom/msmnile_au_s_u/hiber_restore.sh:$(TARGET_COPY_OUT_VENDOR)/bin/hiber_restore.sh
...
# MTMD enablement
PRODUCT_COPY_FILES += \
    device/qcom/msmnile_au_s_u/input-port-associations.xml:$(TARGET_COPY_OUT_VENDOR)/etc/input-port-associations.xml


DEVICE_MANIFEST_FILE := device/qcom/msmnile_au_s_u/manifest.xml
...
PRODUCT_COPY_FILES += device/qcom/msmnile_au_s_u/msm_irqbalance.conf:$(TARGET_COPY_OUT_VENDOR)/etc/msm_irqbalance.conf
...
# Sensor conf files
PRODUCT_COPY_FILES += \
    device/qcom/msmnile_au_s_u/sensors/hals.conf:$(TARGET_COPY_OUT_VENDOR)/etc/sensors/hals.conf \
    frameworks/native/data/etc/android.hardware.sensor.accelerometer.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.sensor.accelerometer.xml \
    frameworks/native/data/etc/android.hardware.sensor.gyroscope.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.sensor.gyroscope.xml

# Kernel modules install path
KERNEL_MODULES_INSTALL := dlkm
KERNEL_MODULES_OUT := out/target/product/msmnile_au_s_u/$(KERNEL_MODULES_INSTALL)/lib/modules
...
DEVICE_PACKAGE_OVERLAYS += device/qcom/msmnile_au_s_u/overlay
