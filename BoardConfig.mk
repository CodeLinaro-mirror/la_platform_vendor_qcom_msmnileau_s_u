...
ifeq ($(TARGET_SINGLE_TREE), true)
  ...
  AB_OTA_PARTITIONS ?= vendor vbmeta vendor_boot boot dtbo vendor_dlkm system_dlkm
endif
#TARGET_NO_RECOVERY := true
...
ifeq (true,$(call math_gt_or_eq,$(SHIPPING_API_LEVEL),34))
  TARGET_RECOVERY_FSTAB := device/qcom/msmnile_au_s_u/msmnileau_fstab_metadata_f2fs/fstab.qcom
else
  TARGET_RECOVERY_FSTAB := device/qcom/msmnile_au_s_u/fstab.qcom
endif
...
BOARD_PREBUILT_DTBOIMAGE := out/target/product/msmnile_au_s_u/prebuilt_dtbo.img
